...
const Home: React.FC = () => {
  return (
    <div>
      ...
      <section className="h-auto flex flex-col items-center justify-center bg-custom-brown px-40 py-10">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-center text-yellow-400">Meet The Team</h1>
        <p className='text-center text-lg mt-6 text-white w-[80%]'>To help monitor and reduce chemical inputs per hectare. To guide for increasing yield and efficiency. 
